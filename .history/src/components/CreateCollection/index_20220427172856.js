...
export const Create = () => {
  ...
  const metadata = {name: nameCollection,symbol: symbol, description: description}
  form.append('author', author);
  form.append('type', type);
  form.append('category', category);
  form.append('metadata',metadata);
  form.append('image',imageCollection);
  ...
  function CreateCollection(event) {
    ...
    axios
      .post(
        "https://app.nftillion.io/admin/collection/create", form,
        // {
