    ...
    <>
      ...
      <div className="main_block_create">
        ...
        <div className="data_block">
          ...
          <label>
            Author
            <input type="text" pattern="/\d+/g" required value={author} onChange={e=>setAuthor(e.target.value)}/>
          </label>
          <label>
            Category
          ...
          <label>
            Type
            <input type="text" pattern="/\d+/g" value={type} onChange={e=>setType(e.target.value)}/>
          </label>
